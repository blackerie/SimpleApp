 ...
 */
    ...
    public class ImageProcessingThread extends AsyncTask<Void, Void, Void> {
        ...
        public ImageProcessingThread(OcrScannerListener ocrScannerListener, String filePath,
        ...
        private String scanImage() {
            ...
            //set characters that will be recognized and others that will not
            baseApi.setVariable(TessBaseAPI.VAR_CHAR_BLACKLIST, "!@#$%^&*()_+=-qwertyuiop[]}{U" +
                    "YEWQasdfghGHjklJKLl;L:'\\\"\\\\|~`xcvXVbnmBM,./<>?");
            baseApi.setVariable(TessBaseAPI.VAR_CHAR_WHITELIST, "SANFRCIOPTD");
